...
"D:\IAR\common\bin\cspybat" -f "D:\Drone Vacation Study\1st_week\FILE_SEPERATE_PRACTICE\EWARM\settings\FILE_SEPERATE_PRACTICE.FILE_SEPERATE_PRACTICE.general.xcl" "--debug_file=%~1" --backend -f "D:\Drone Vacation Study\1st_week\FILE_SEPERATE_PRACTICE\EWARM\settings\FILE_SEPERATE_PRACTICE.FILE_SEPERATE_PRACTICE.driver.xcl" 
